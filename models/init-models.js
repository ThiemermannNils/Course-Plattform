...
var _course_progress = require("./course_progress");
...
function initModels(sequelize) {
  var course_progress = _course_progress(sequelize, DataTypes);
  ...
  course_progress.belongsTo(tbl_course, { as: "fk_course", foreignKey: "fk_course_id"});
  tbl_course.hasMany(course_progress, { as: "course_progresses", foreignKey: "fk_course_id"});
  ...
  course_progress.belongsTo(tbl_users, { as: "fk_user", foreignKey: "fk_users_id"});
  tbl_users.hasMany(course_progress, { as: "course_progresses", foreignKey: "fk_users_id"});
